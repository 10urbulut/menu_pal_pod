...
CREATE TABLE "menu" (
    ...
    "phone" text,
    "email" text,
    "restaurantTypes" json
);

--
-- Class RestaurantType as table restaurant_type
--
...
--
-- Foreign relations for "city" table
--
...
--
-- Foreign relations for "district" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('menu_pal', '20241007081406348', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20241007081406348', "timestamp" = now();
