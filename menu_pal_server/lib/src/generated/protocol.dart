...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.District) {
      return _i7.District.fromJson(data) as T;
    }
    if (t == _i8.Example) {
    ...
    if (t == _i1.getType<_i7.District?>()) {
      return (data != null ? _i7.District.fromJson(data) : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i6.Country) {
      return 'Country';
    }
    if (data is _i7.District) {
      return 'District';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'District') {
      return deserialize<_i7.District>(data['data']);
    }
